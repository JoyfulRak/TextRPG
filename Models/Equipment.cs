...
public class Equipment:Item
{
    ...
    public static Equipment CreateWeapon(string weaponType)
    {
        switch (weaponType)
        {
            ...
            case "철검":
                return new Equipment("철검", "강력한 무기", 500, EquipmentSlot.Weapon, 15);
            case "전설검":
                return new Equipment("전설검", "최고의 무기", 1000, EquipmentSlot.Weapon, 25);
            default:
                return null;
    ...
    public static Equipment CreateArmor(string armorType)
    {
        ...
        {
            case "가죽갑옷":
                return new Equipment("가죽갑옷", "기본 방어구", 100, EquipmentSlot.Armor, 0, 5);
            case "철갑옷":
                return new Equipment("철갑옷", "강력한 방어구", 500, EquipmentSlot.Armor, 0, 15);
            case "전설갑옷":
                return new Equipment("전설갑옷", "최고의 방어구", 1000, EquipmentSlot.Armor, 0, 25);
            default:
                return null;
        }
    }
